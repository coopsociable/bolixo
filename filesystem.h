...
unsigned fs_find_inbox (unsigned ownerid, PARAM_STRING name, int noproc, std::string &msg);
unsigned fs_find_outbox (unsigned ownerid, PARAM_STRING name, int noproc, std::string &msg);
