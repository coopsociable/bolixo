...
std::string util_format_shortmsg (PARAM_STRING txt, unsigned nblines, size_t size, unsigned image_width, bool validate, CONNECT_INFO &con, std::string &errmsg
	, bool &truncated);
std::string util_format_shortmsg (PARAM_STRING txt, unsigned nblines, size_t size, unsigned image_width, bool validate, CONNECT_INFO &con, std::string &errmsg);
std::string util_format_shortmsg (PARAM_STRING txt, unsigned nblines, size_t size, unsigned image_width,bool &truncated);
...
void util_endscript(bool fixsize_delay, PARAM_STRING urlparam);
